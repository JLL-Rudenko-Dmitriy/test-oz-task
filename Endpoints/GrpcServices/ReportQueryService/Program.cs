...
using ReportQueryService.Interceptors.Validation;
...
builder.Services
    .AddGrpc()
    .AddServiceOptions<ReportQueryService.Services.ReportQueryService>(options =>
    {
        options.Interceptors.Add<GetReportValidationInterceptor>();
        options.Interceptors.Add<NewReportQueryValidationInterceptor>();
    });
...
app.MapGrpcService<ReportQueryService.Services.ReportQueryService>();
